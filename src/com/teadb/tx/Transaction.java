package com.teadb.tx;

import com.teadb.file.*;
import com.teadb.log.LogMgr;
import com.teadb.buffer.*;
import com.teadb.tx.recovery.*;
import com.teadb.tx.concurrency.ConcurrencyMgr;
...
public class Transaction {
    ...
    * {@link teadb.server.teadb}.
    * Those objects are created during system initialization.
    * Thus this constructor cannot be called until either
    * {@link teadb.server.teadb#init(String)} or 
    * {@link teadb.server.teadb#initFileLogAndBufferMgr(String)} or
    * is called first.
    */

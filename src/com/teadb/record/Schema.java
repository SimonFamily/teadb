...
public class Schema {
	...
	/**
	 * Add a field to the schema having a specified name, type, and length. If the
	...
	/**
	 * Add a string field to the schema. The length is the conceptual length of the
	...
	/**
	 * Return the type of the specified field, using the constants in
	 * {@link java.sql.Types}.
	 * 
	 * @param fldname the name of the field
